...
def create_outfile(inputfile):
    return '/home/cumulus/cp/Users/gryspeerdt/tho_'+os.path.basename(inputfile)+'.refl2m'
    #return inputfile+'.refl2m'
...
def calc_refl(inputfile):
    ...
    qb.settings['hclass_file'] = 'data/hclass_wrf_thompson.dat'
    qb.read_hclass()
